...
const ShareableReportScreen: React.FC<Props> = ({ onNavigate }) => {
  ...
  const handleExport = async () => {
    ...
    try {
      await exportNodeAsPng(contentRef.current, { fileName: 'tiizi-shareable-report.png', backgroundColor: '#f8f7f6' });
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 font-display flex flex-col">
      <header className="px-4 pt-12 pb-2 flex items-center justify-between">
        ...
        <h2 className="text-lg font-bold leading-tight tracking-[-0.015em] flex-1 text-center pr-10">Shareable Report</h2>
      ...
      <main className="flex-1 px-6 pt-6 pb-40">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          {/* Main Card */}
          <div className="w-full bg-primary rounded-[48px] p-10 flex flex-col items-center text-center text-white shadow-2xl shadow-primary/30 relative overflow-hidden">
