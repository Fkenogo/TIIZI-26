        ...
        <div className="space-y-10">
          <label className="flex flex-col gap-3">
            ...
            <textarea 
              ...
              defaultValue="Team, our 30-Day Plank Challenge starts tomorrow! Get ready."
          ...
          <section className="space-y-4">
            {[
              { label: 'Pin to top of Chat', icon: 'push_pin', active: true },
              { label: 'Send as Push Notification', icon: 'notifications_active', active: true }
            ].map((opt, i) => (
              <div key={i} className="flex items-center justify-between p-6 bg-white dark:bg-zinc-800 rounded-[28px] shadow-sm border border-slate-50 dark:border-zinc-700">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input defaultChecked={opt.active} className="sr-only peer" type="checkbox" />
          ...
          <section className="space-y-6 pt-6">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-[32px] overflow-hidden border-2 border-slate-100 dark:border-zinc-800 shadow-xl">
              <div className="bg-slate-50 dark:bg-zinc-800/50 p-4 flex items-center gap-3 border-b border-slate-50 dark:border-zinc-800">
                ...
                <div>
                  <p className="text-xs font-black uppercase tracking-tight">Fitness Warriors</p>
                  <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">12 members active</p>
                </div>
              </div>
              <div className="bg-primary px-6 py-4 flex items-center gap-4 text-white">
                ...
                <p className="text-xs font-bold leading-relaxed flex-1">Team, our 30-Day Plank Challenge starts tomorrow! Get ready.</p>
