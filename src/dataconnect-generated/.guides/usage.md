...
```ts
import { useCreateNewGroup, useGetMyWorkouts, useJoinGroup, useListPublicGroups } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateNewGroup(createNewGroupVars);

const { data, isPending, isSuccess, isError, error } = useGetMyWorkouts();
...
```js
import { createNewGroup, getMyWorkouts, joinGroup, listPublicGroups } from '@dataconnect/generated';
