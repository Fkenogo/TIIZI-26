      ...
      <main className="flex-1 flex flex-col items-center justify-center px-8 pb-10">
        ...
        <div className="relative w-full max-w-[340px] bg-white dark:bg-[#1a1510] p-10 rounded-[56px] shadow-2xl border-8 border-white/5 flex flex-col items-center gap-10">
           <div className="size-56 bg-white p-6 rounded-[32px] shadow-inner border-4 border-slate-50 relative group cursor-pointer transition-transform hover:scale-[1.02]">
              <img src="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=tiizi-profile-alex" alt="QR" className="size-full opacity-90 grayscale group-hover:grayscale-0 transition-all duration-500" />
           ...
           <div className="w-full bg-slate-50 dark:bg-[#2d2115] p-5 rounded-[32px] flex items-center justify-between gap-5 border border-slate-100 dark:border-white/5">
              <div className="flex-1 space-y-1.5">
                <p className="font-black text-lg tracking-tight">Alex Chen</p>
                <div className="flex items-center gap-2 text-primary">
                  <span className="material-symbols-rounded text-sm font-variation-fill">local_fire_department</span>
                  <p className="text-[10px] font-black uppercase tracking-widest">15 Day Workout Streak</p>
                </div>
              </div>
              <img className="size-14 rounded-2xl object-cover border-2 border-primary/20 shadow-md grayscale" src="https://picsum.photos/id/64/150/150" alt="avatar" />
           </div>
        ...
        <div className="w-full max-w-[340px] mt-10 space-y-4">
           <button className="w-full h-16 bg-primary text-white rounded-[24px] font-black uppercase tracking-[0.1em] text-sm shadow-xl shadow-primary/20 flex items-center justify-center gap-4 active:scale-95 transition-all group">
             <span className="material-symbols-rounded group-hover:rotate-12 transition-transform">link</span>
             Copy Profile Link
           </button>
           <button className="w-full h-16 bg-primary/10 dark:bg-primary/20 text-primary rounded-[24px] font-black uppercase tracking-[0.1em] text-sm flex items-center justify-center gap-4 active:scale-95 transition-all group">
